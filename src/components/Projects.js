...
export default function Projects() {
  return (
    ...
    <div className="d-flex flex-row flex-wrap justify-content-around">
        ...
        <Frame content={"This website is one of my projects, created using React.js with Bootstrap. The source code can be found on my GitHub page, where the website is also hosted."} image={Webpage}/>
        ...
        <Frame content={"One of my engineering projects involved designing and manufacturing a CNC machine using 3D printing techniques. The entire machine was designed in Fusion 360 and then fabricated and assembled."} image={CNC}/>
        ...
        <Frame content={"I built the front-end web page for a Mobile Photokiosk using Blazor technology, .NET, and C#. This website was developed during my internship at Pixel-Tech."} image={pixel}/>
