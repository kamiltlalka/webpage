...
export default function Projects() {
  return (
    ...
    <div className="d-flex flex-row flex-wrap justify-content-around">
        ...
        <Frame content={"This website is one of my projects. It was made using React.js with Bootstrap. The source code can be found on my github page, where the page is hosted"} image={P1}/>
